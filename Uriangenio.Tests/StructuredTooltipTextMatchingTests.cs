...
public class StructuredTooltipTextMatchingTests
{
    ...
    public void NormalizeStructuredTooltipLookupText_CollapsesWhitespaceAndFormatNoise()
    {
        ...
        var result = global::Echoglossian.Echoglossian.NormalizeStructuredTooltipLookupText(input);
    ...
    public void ComputeStructuredTooltipTextMatchScore_MatchesWrappedDescription()
    {
        ...
        var result = global::Echoglossian.Echoglossian.ComputeStructuredTooltipTextMatchScore(
            visibleText,
            canonicalText);
    ...
    public void IsStructuredTooltipExactTextMatch_MatchesDecoratedItemName()
    {
        ...
        var result = global::Echoglossian.Echoglossian.IsStructuredTooltipExactTextMatch(
            visibleText,
            canonicalText);
    ...
    {
        var result = global::Echoglossian.Echoglossian.CanApplyStructuredTooltipNative(
    ...
    {
        IReadOnlyList<global::Echoglossian.Echoglossian.StructuredTooltipTextNodeCandidate> candidates =
        [
            new global::Echoglossian.Echoglossian.StructuredTooltipTextNodeCandidate(
                (nint)1,
                "Standard Step",
                global::Echoglossian.Echoglossian.NormalizeStructuredTooltipLookupText(
                    "Standard Step"),
                false),
            new global::Echoglossian.Echoglossian.StructuredTooltipTextNodeCandidate(
                (nint)2,
        ...
        var found = global::Echoglossian.Echoglossian.TryFindBestStructuredTooltipTextNodeCandidate(
            candidates,
            "Standard Step",
    ...
    public void TryFindBestStructuredTooltipExactTextNodeCandidate_RejectsSubstringOnlyCandidate()
    {
        ...
        var found = global::Echoglossian.Echoglossian.TryFindBestStructuredTooltipExactTextNodeCandidate(
            candidates,
    ...
    {
        Assert.False(
            global::Echoglossian.Echoglossian.ShouldUseActionDetailAgentFallback(
                hoveredActionId: 0,
                hoveredItemId: 23167));
        Assert.True(
            global::Echoglossian.Echoglossian.ShouldUseActionDetailAgentFallback(
    ...
    {
        Assert.False(
            global::Echoglossian.Echoglossian.ShouldUseItemDetailAgentFallback(
                hoveredItemId: 0,
