...
using Uriangenio.Tests.TestDoubles;
...
public class TranslatorFactoryTests
{
    ...
    public void Create_ConstructsExpectedTranslatorForEveryConcreteEngine()
    {
        ...
        global::Echoglossian.Echoglossian.SelectedLanguage = new LanguageInfo(
            "pt",
    ...
    public void Create_All_Throws()
    {
        ...
        var exception = Assert.Throws<NotSupportedException>(() =>
            TranslatorFactory.Create(global::Echoglossian.Echoglossian.TransEngines.All, config, pluginLog));
