...
public class MainCommandTextPersistenceTests
{
    ...
    {
        Assert.Null(global::Echoglossian.Echoglossian.NormalizeMainCommandSortId(-1));
        Assert.Equal((uint)0, global::Echoglossian.Echoglossian.NormalizeMainCommandSortId(0));
        Assert.Equal((uint)40, global::Echoglossian.Echoglossian.NormalizeMainCommandSortId(40));
    }
    ...
    {
        Assert.Null(global::Echoglossian.Echoglossian.NormalizeMainCommandUnknown0(0));
        Assert.Equal((uint)9, global::Echoglossian.Echoglossian.NormalizeMainCommandUnknown0(9));
    }
